# terraform/corporate/config.tf

# =====================================================================
# AWS Config Service-Linked Role
# =====================================================================
# AWSServiceRoleForConfig carries all permissions Config needs, including
# cross-account S3 delivery. The target bucket's policy scopes access via
# aws:SourceOrgID, so no additional inline delivery policy is required.
#
